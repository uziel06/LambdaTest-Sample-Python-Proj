...
#Setup to execute on LambdaTest Platform and for Cross-browser testing
username = "" # Replace the username with your lambdatest username
access_key = "" # Replace the access key with your lambdatest access key that can be found after registering to their platform

#Setup to run in Chrome and Windows 10 OS
...
#Setup to run in Microsoft Edge and macOS
@pytest.fixture(scope="class")
